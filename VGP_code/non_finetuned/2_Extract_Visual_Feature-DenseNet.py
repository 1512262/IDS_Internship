...
def visual_model():
    ...
    after_rois = RoiPooling(pool_size=7,batch_size=BATCH_SIZE,name='roi_pooling')([before_rois,rois])
    x = GlobalAveragePooling2D(name='global_avg_pool')(Activation('relu',name='relu')(after_rois))
